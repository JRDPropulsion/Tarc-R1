...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  3, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel1, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // ADC/AIN[3] // I modified this to A2
  ...
  // 38..41 - EDBG/Digital
  /*Placeholder - not broken out */ { PORTA, 13, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM0_CH5, NOT_ON_TIMER, EXTERNAL_INT_13 }, // 38: EIC/EXTINT[13] *TCC2/WO[1] TCC0/WO[7]
  ...
  // 42 (AREF)
  { PORTB, 9, PIO_ANALOG, PIN_ATTR_ANALOG, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DAC/VREFP
